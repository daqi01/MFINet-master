...
def print_metrics(method, dura, r_mse, r_mae, t_mse, t_mae, r_isotropic, t_isotropic):
    ...
    print('isotropic R(rot) error: {:.3f}'.format(r_isotropic))
    print('isotropic t error: {:.4f}'.format(t_isotropic))
    print('anisotropic rmse R error: {:.3f}'.format(r_mse))
    print('anisotropic mae R error: {:.3f}'.format(r_mae))
    print('anisotropic rmse t error : {:.4f}'.format(t_mse))
